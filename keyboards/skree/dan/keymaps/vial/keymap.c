...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    const int led_index_1 = 20;
    const int led_index_2 = 43;
    switch(get_highest_layer(layer_state)) {
        case 1:
            rgb_matrix_set_color(led_index_1, RGB_WHITE);
            rgb_matrix_set_color(led_index_1 + 1, RGB_WHITE);
            rgb_matrix_set_color(led_index_1 + 2, RGB_WHITE);

            rgb_matrix_set_color(led_index_2, RGB_WHITE);
            rgb_matrix_set_color(led_index_2 + 1, RGB_WHITE);
            rgb_matrix_set_color(led_index_2 + 2, RGB_WHITE);
            return true;
        case 2:
            rgb_matrix_set_color(led_index_1, RGB_BLUE);
            rgb_matrix_set_color(led_index_1 + 1, RGB_BLUE);
            rgb_matrix_set_color(led_index_1 + 2, RGB_BLUE);

            rgb_matrix_set_color(led_index_2, RGB_BLUE);
            rgb_matrix_set_color(led_index_2 + 1, RGB_BLUE);
            rgb_matrix_set_color(led_index_2 + 2, RGB_BLUE);
            return true;
        case 3:
            rgb_matrix_set_color(led_index_1, RGB_GREEN);
            rgb_matrix_set_color(led_index_1 + 1, RGB_GREEN);
            rgb_matrix_set_color(led_index_1 + 2, RGB_GREEN);

            rgb_matrix_set_color(led_index_2, RGB_GREEN);
            rgb_matrix_set_color(led_index_2 + 1, RGB_GREEN);
            rgb_matrix_set_color(led_index_2 + 2, RGB_GREEN);
            return true;
        default:
            return false;
    }
